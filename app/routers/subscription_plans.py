...
@router.post("/api/add_to_subscription_plans")
...
@router.get("/api/get_subscription_plans")
async def get_subscription_plans(db: Session = Depends(get_db)):
    return SubscriptionPlansService(db).get_subscription_plans()


@router.put("/api/update_subscription_plans")
...
@router.delete("/api/delete_subscription_plans")
